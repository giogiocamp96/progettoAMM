...
CREATE TABLE amicizia(
    ...
    FOREIGN KEY (id_ut1) REFERENCES utente(id),
    FOREIGN KEY (id_ut2) REFERENCES utente(id)
);
...
INSERT INTO post (id, testo, urlImmagine, urlLink, idutente)
VALUES (default,'Il Conte avrà una sorpresina grazie alla mia nuova invenzione! Ahahah!', 'M3/immagini/olaf.jpg', '', 1 ), 
       (default, 'Mi hanno appena regalato una trottola di legno, ma l ho mangiata!', '', '', 2), 
       (default, 'Questa è la brutta copia del mio cannocchiale speciale. #povery', '', 'https://it.wikipedia.org/wiki/Cannocchiale', 3), 
       (default, 'Ragazzi, sono veramente euforica!', '', '', 1);

INSERT INTO gruppo (id, nome, urlFoto, frase)
VALUES (default, 'Ignoranti disagiati', '', 'blablabla'), 
       (default, 'Sesi de Murera se...', '', 'Benvenuti nel paese dei pidanciuli!'), 
       (default, 'Fotografia', '', 'Siamo qui per criticarti.');
